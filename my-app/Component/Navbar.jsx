...
export default function Navbar({cartCount}) {
  ...
  <h1 className="text-5xl  ml-49 font-bold">
   ...
   <a href="/" className="flex items-center gap-2 group">
        ...
        {/* Ecommerce Icon */}
        <FaShoppingBag className="text-orange-500 text-3xl group-hover:scale-110 transform transition duration-300 ease-in-out" />
      </a>

        </li>
        <ul className="w-full flex justify-center  text-2xl items-center gap-6">  
        <li className="font-['Lato'] cursor-pointer  hover:text-orange-500 transition">Men</li>
        <li className="font-['Lato'] cursor-pointer  hover:text-orange-500 transition">Women</li>
        <li className="font-['Lato'] cursor-pointer  hover:text-orange-500 transition">Boys</li>
        <li className="font-['Lato'] cursor-pointer  hover:text-orange-500 transition">Girls</li>
        </ul>
      </ul>
      ...
      <ul className="w-full flex justify-center items-center gap-4">
        ...
        {/* Basket Icon */}
        <li>
          <a className="relative hover:text-orange-500 transition " href="/basket">
            <svg
              stroke="currentColor"
              fill="currentColor"
